...
class DashboardController extends Controller
{
    public function index()
    {
       ...
       $tag_count = Tag::all()->count();
        ...
        return view('admin.dashboard',['postview'=>$postsview],compact('posts','popular_posts','total_pending_posts','all_views','author_count','new_authors_today','active_authors','category_count','tag_count'));
    }
}
